...
/**
 * Abstract class for splitting media into multiple files based on their
 * location
 * 
 * @author Peijin Zhang
 */
public abstract class AbstractSplitter {
   ...
   *          Path to input file
   * @param num
   *          Number of screens to split file over
   * @param aspect
   *          Aspect ratio of the screens
   * @param distribution
   *          Desired distribution of the screens, nullable
   */
  ...
  /**
   * Returns the distribution of screens for the splitting First element is
   * number of columns, second is number of rows
   */
  public int[] getDistribution() throws Exception {
    int[] dist = new int[2];
   ...
   */
  public int getScreensUsed() throws Exception {
   ...
   */
  int[] getNewResolution() throws Exception {
  ...
  abstract int[] getResolution() throws Exception;
