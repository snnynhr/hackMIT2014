...
/**
 * Every time this is called, will simply print out a random string to console
 * that consists of adjective + adjective + noun. Used for generation of random
 * URLs
 * 
 * @author Peijin Zhang
 */
public class MakeRandomURL {
  ...
  private void printRandomURL(ArrayList<String> adjectives, ArrayList<String> nouns) {
    ...
    System.out.println(capitalize(adjectives.get(firstadj)) + capitalize(adjectives.get(secondadj))
